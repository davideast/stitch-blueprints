...
## What it moves
Introduces strict vertical split, gives each side equal authority, allows each half to have its own color/texture/type treatment. The seam between them is the focal point.
